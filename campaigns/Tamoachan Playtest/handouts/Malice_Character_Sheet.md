# Character Record Sheet - MALICE INDARAE DE'BARAZZAN

**Character Name:** Malice Indarae De'Barazzan **Player:** Open Pruskowski
...
|---------|-------|----------|-------|
| **STR** | 15 | +1 | |
| **INT** | 17 | +4 | Languages: 7 |
| **WIS** | 17 | +3 | Spell Bonus: 2nd |
| **DEX** | 15 | +1 | Reaction: +1, Missile: +1 |
| **CON** | 15 | +2 | HP Bonus: +2/lvl |
| **CHA** | 11 | 0 | Henchmen: 4 |
...
|---|---|---|
| **HP** | 42 | 42 |
| **AC** | 0 | (Base: 5, Armor: -3, Ring: -2) |

**THAC0:** 16  **Movement:** 12"
...
*Modifiers: Ring of Protection +2, Luck Stone +1*
...
### Level 1 Spells (Max: 8 / Day - Ring of Wizardry: 2x)
...
## Innate Abilities / Special Powers (Drow)

| Ability | Uses/Day | Used | Notes |
|---------|----------|------|-------|
| Darkness (60' radius) | 1 | ☐ | Innate |
| Faerie Fire | 1 | ☐ | Innate |
| Levitation | 1 | ☐ | Innate |
| Detect Secret Doors | At will | - | 1 in 6 passing, 2 in 6 searching |
| Infravision | Constant | - | 60' range |
| Magic Resistance | Constant | - | 50% + 2%/level |
| +1 to hit orcs, goblins | Constant | - | |
| -4 damage from giants | Constant | - | |

**Spell-like Abilities from Items:**
| Ability | Source | Uses | Used |
|---------|--------|------|------|
| Water Breathing | Armor | 1/day | ☐ |
...
|------|-----|--------|----------|
| Holy Symbol | 1 | 1 | Neck |
| Spell Book | 1 | 5 | Backpack |
| Rations (iron) | 7 | 7 | Backpack |
| Water Skin | 1 | 4 | Belt |
| Torch | 3 | 3 | Backpack |
| Rope (50') | 1 | 10 | Backpack |
| Healing Potion | 2 | 2 | Belt pouch |
| Antitoxin | 1 | 1 | Belt pouch |
| Thieves' Tools | 1 | 1 | Belt |
| Blanket | 1 | 3 | Backpack |
| Tinderbox | 1 | 1 | Belt pouch |
...
|------|-------|----------|-------|
| Armor of Sunken King +3 | 15,000 gp | Worn | Water breathing 1/day |
| Ring of Protection +2 | 10,000 gp | Finger | +2 AC, +2 saves |
| Ring of Wizardry | 25,000 gp | Finger | Doubles 1st level mage spells |
| Luck Stone | 5,000 gp | Pocket | +1 all saves |
...
*Malice Indarae De'Barazzan - Tamoachan Playtest*
