# Character Record Sheet - GROND

**Character Name:** Grond **Player:** _________________________
...
|---|---|---|
| **HP** | 69 | 69 |
| **AC** | 0 | (Plate +1: -4, Shield +1: -2, Dex: 0) |
...
|--------|--------------|------------|--------|-------|
| **Mace +3** | 4-11 | 3-10 | +6 | Primary weapon |
| **Uthul (+2 Axe)** | 3-10 | 2-9 | +5 | Vorpal vs giants (18-20) |
...
|------|------|----------|--------|
| **Armor** | Plate Mail +1 | -4 | 50 |
| **Shield** | Shield +1 | -2 | 10 |

**Total Weight:** 60 lbs  **Movement:** 9"

---

## CLERIC SPELLS

### Level 1 Spells (Max: 2 / Day)
...
**Mace +3**
- Damage: 4-11 (S-M), 3-10 (L)
- To-Hit: +6 (+3 mace, +3 STR)
- Value: 3,000 gp

**Uthul (+2 Battle Axe)**
- Damage: 3-10 (S-M), 2-9 (L)
- To-Hit: +5 (+2 axe, +3 STR)
- Special: Vorpal vs giant class creatures (sever limb on 18-20)
- Value: 5,000 gp
...
*Grond - Half-Ogre Fighter 6/Cleric 4*
